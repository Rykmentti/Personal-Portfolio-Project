...
public class BossMiekka : MonoBehaviour
{
    ...
    void Start()
    {
        threshold = GetComponentInParent<BossEnemyController>().threshold;
        localPosition = GetComponentInParent<BossEnemyController>().localPosition;
        startRotation = GetComponentInParent<BossEnemyController>().startRotation;
